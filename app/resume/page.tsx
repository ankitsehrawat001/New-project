  ...
  return (
    <section className="section pt-32">
      <div className="container-premium">
        <SectionHeader eyebrow="Resume" title="Ankit - AI/ML Developer and React.js Builder." />
        <Card className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <p className="text-[color:var(--muted)]">A focused resume page for AI/ML projects, Python skills, and React.js presentation work.</p>
          <ButtonLink href="/contact"><Download size={16} /> Request Resume</ButtonLink>
        </Card>
